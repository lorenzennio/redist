...
def null_dist(x, y, a=1.0, b=1.0):
    return a * x**2 + b * y**2


def alt_dist(x, y, a=2.0, b=0.5):
    return null_dist(x, y, a, b)


class TestSimpleModel:
    xbinning = np.linspace(0.0, 10.0, 5)
    ybinning = np.linspace(4.0, 8.0, 4)
                        ...
                        "modifiers": [
                            {
                                ...
                                "type": "shapesys",
                                "data": [
                                    np.sqrt(20 * i**2) for i in range(len(mapping_dist))
                                ],
                            }
                        ],
                    },
